...
## [2.68.0](https://github.com/ClientifySL/emailengine/compare/v2.67.3...v2.68.0) (2026-05-19)
...
* Add support for Gmail send-only accounts ([#554](https://github.com/ClientifySL/emailengine/issues/554)) ([47fb593](https://github.com/ClientifySL/emailengine/commit/47fb593cfe390f066bd99ff84257abb036782d64))
* Add support for Outlook send-only accounts ([6b63ee4](https://github.com/ClientifySL/emailengine/commit/6b63ee4dff1feff087ab65e6233317cae8a4aad7))
...
* **api:** Add mailbox subscription management to modify endpoint ([4578c8a](https://github.com/ClientifySL/emailengine/commit/4578c8a89f56725ec02a3d9e2418c141acea4db1))
...
* **health:** Add worker health monitoring with heartbeat system ([34724e8](https://github.com/ClientifySL/emailengine/commit/34724e876a021d6de30bffff54856bb9a2c6ef76))
...
* **internals:** Add CPU monitoring for worker threads ([8aa9be5](https://github.com/ClientifySL/emailengine/commit/8aa9be5ab7a09c7d12745d2ddc3632da868d0bcb))
...
* **resilience:** Add circuit breaker pattern for worker communication ([79ea27a](https://github.com/ClientifySL/emailengine/commit/79ea27aed0ae7c5c856746809d43f53bacf3ed2b))
...
* Add retry logic for transient errors when fetching referenced messages ([9312f4b](https://github.com/ClientifySL/emailengine/commit/9312f4bcc95b2423e4bd98e3eeef1230aa02fcb9))
...
* **attachments:** Bumped Nodemailer for fix issue with large data-uri images in emails ([44cd002](https://github.com/ClientifySL/emailengine/commit/44cd002933635435626739e395bfdf8ba9679be2))
...
* Bumped email-text-tools to fix webSafe processing ([ae6f2f1](https://github.com/ClientifySL/emailengine/commit/ae6f2f149ab675faaa9de5490809400b5c24996d))
* Bumped ImapFlow module for improved IMAP handling stability ([5f7ce73](https://github.com/ClientifySL/emailengine/commit/5f7ce73eb270f3f92fdd17398842ad003c628612))
* Bumped ImapFlow to decrease load on CPU ([227894d](https://github.com/ClientifySL/emailengine/commit/227894dbbc68f6b7d5cf5322d1010678940107c1))
...
* Correct OpenAPI response schema and add Docker CLI support ([38d39d6](https://github.com/ClientifySL/emailengine/commit/38d39d615d7e268261f4d8b49a7e79a943d9c553))
...
* dark mode support for message browser ([59d3c31](https://github.com/ClientifySL/emailengine/commit/59d3c31d58ea46d31b9908188b599c2169da87f7))
* **delegated:** Fixed mailbox listing for delegated OAuth2 accounts ([9fc74fd](https://github.com/ClientifySL/emailengine/commit/9fc74fd41e00a92eb121a85efa134947497de608))
...
* Ensure mailbox ID persistence during flush ([bb26992](https://github.com/ClientifySL/emailengine/commit/bb26992f110e640fa0f98f64dd714a20ac35c085))
* **env:** Added EENGINE_DISABLE_MESSAGE_BROWSER, fixed EENGINE_ADMIN_ACCESS_ADDRESSES regression bug ([4d922ff](https://github.com/ClientifySL/emailengine/commit/4d922ff9c7eb7ca6839657430adc3df7013a7204))
...
* Fixed build ([ac5d3b4](https://github.com/ClientifySL/emailengine/commit/ac5d3b4b700752e42acd0b7028bfdf622eac1f0a))
* Fixed checking nil against a number ([eee7294](https://github.com/ClientifySL/emailengine/commit/eee7294d1e4cd328ba1cff8aeb704d86a6fd767f))
* **flush:** Allow flushing non-connected accounts ([07eebc5](https://github.com/ClientifySL/emailengine/commit/07eebc55ba2d4341d92fb7a1d9078449750b2a7c))
...
* **imap:** Fix uneven IMAP worker thread distribution ([339f0e0](https://github.com/ClientifySL/emailengine/commit/339f0e0b8f7a382a42c29460526a9ddfac91a0fe))
* **imap:** Fixed subconnection error handling ([5367c77](https://github.com/ClientifySL/emailengine/commit/5367c77f88690a3636049e0690d2f674e1528a30))
* **imap:** Prevent 100% CPU usage from reconnection loops ([4d1bf7d](https://github.com/ClientifySL/emailengine/commit/4d1bf7da53d299f0b203eb09b4ec790848c6cf09))
...
* **install:** Fixed Redis password generation for the install script ([bf5853e](https://github.com/ClientifySL/emailengine/commit/bf5853e0c394a98d3bad079293dd5e73206d5183))
* **internals:** Handle unresponsive workers gracefully in admin internals page ([2a2d94b](https://github.com/ClientifySL/emailengine/commit/2a2d94b916e32b7a5f8a2741dbd8fbb265b98605))
...
* limit session token usage for the message browser ([41ead92](https://github.com/ClientifySL/emailengine/commit/41ead924917930f828f996b43c6a16a73c8c7bb9))
* **lint:** Remove unused HEARTBEAT_INTERVAL constant and add npm lint script ([19209ab](https://github.com/ClientifySL/emailengine/commit/19209ab254bfa1262fa5e34f994db51ebca61f5a))
...
* **lua:** Fix bugs and add documentation to Redis Lua scripts ([1c4889f](https://github.com/ClientifySL/emailengine/commit/1c4889f9e055e3c9b16b11513583abc494c92a15))
...
* **memory:** Add LRU-based cleanup for SMTP connection pools ([fba58e8](https://github.com/ClientifySL/emailengine/commit/fba58e8069d74a0738cebab478188eee31749678))
* message browser uses theme based confirm instead of sync javascript confirm ([9409d2c](https://github.com/ClientifySL/emailengine/commit/9409d2c7e4a93fd9ab16876baf52294968511840))
* **metrics:** Implement background metrics collection to prevent CPU spikes ([b0a200a](https://github.com/ClientifySL/emailengine/commit/b0a200a8e491bddcf1a3896e12253523036ad339))
...
* **oauth:** Update Redis hash mapping when OAuth email changes ([82c1d89](https://github.com/ClientifySL/emailengine/commit/82c1d89dcf81edc198bcdf3dcc266506cb534da2))
* **outlook:** Fix MS Graph webhook subscription expiration issues ([1153313](https://github.com/ClientifySL/emailengine/commit/1153313868fae506cee9c13805628fddf6101e17))
...
* race condition in runFullSync and add diagnostic logging ([#549](https://github.com/ClientifySL/emailengine/issues/549)) ([cdb3fe1](https://github.com/ClientifySL/emailengine/commit/cdb3fe18b2494cc02f1e50e98ffddf0003329dd2))
* **redis:** Add recovery mechanism for disconnected accounts after Redis reconnection ([ac9737a](https://github.com/ClientifySL/emailengine/commit/ac9737a98bdb50220278e809de408582f789cf05))
...
* **redis:** Improve Redis reconnection handling for IMAP workers ([de7327e](https://github.com/ClientifySL/emailengine/commit/de7327e08ca676607433890060f045bbc851a3a7))
...
* Remove CPU metrics collection to prevent potential native code issues ([350afc2](https://github.com/ClientifySL/emailengine/commit/350afc2a74e2935f74ad0b00110cd6e67eafc5b0))
...
* Replace v8.getHeapStatistics with process.memoryUsage to prevent SEGV errors ([918dba7](https://github.com/ClientifySL/emailengine/commit/918dba7682a6e50f6aec8c91fe1e35a3f0eb2928))
...
* Simplify memory display in internals page ([8dc284b](https://github.com/ClientifySL/emailengine/commit/8dc284b90360f747dd0c7d98115b5352544a028b))
...
* Update internals page to handle new memory usage format ([cf0de82](https://github.com/ClientifySL/emailengine/commit/cf0de827b17b13e9234d347f5f6686de29bfb7d2))
...
* **verify:** Slightly faster account data verification ([3e27d5e](https://github.com/ClientifySL/emailengine/commit/3e27d5e75f4a59e97aca7a3eff8a041c3d540935))
* **webhooks:** Explicitly set Content-Length to prevent undici mismatch errors ([40cb42d](https://github.com/ClientifySL/emailengine/commit/40cb42dfefdbc55eb2eca5c61c15565de5e85d8e))
* **webhooks:** Show more informational messages when webhooks fail ([0712f0a](https://github.com/ClientifySL/emailengine/commit/0712f0a0d547b61ba95be34346523ee8fe32210f))
